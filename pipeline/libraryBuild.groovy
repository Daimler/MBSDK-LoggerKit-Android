...
def GIT_URL = 'https://github.com/Daimler/MBSDK-LoggerKit-Android.git'
def MODULE_NAME = 'mbloggerkit'
def CONFIG = 'Release'
def BRANCH = 'develop'
...
node(NODE) {
    ...
    def docsSpec = new ModuleDocumentationSpec('jekyll', '_logger_docs', 'gfm', 'modules/logger')
    androidPipeline.doStableLibraryBuild(GIT_URL, MODULE_NAME, CONFIG, BRANCH, true, vaultConfig, docsSpec)
}